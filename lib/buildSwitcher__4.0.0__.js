...
var buildAndOutputSwitcher = (function() {
  var _ref2 = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
    _regenerator.default.mark(function _callee(_ref, babelCoreOpts, filename) {
      var multiVersions,
        outDir,
        extname,
        basename,
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                extname = _path.default.extname(filename);
                basename = _path.default.basename(filename, extname);
                indexDest = _path.default.join(outDir, `${basename}${extname}`);
